...
# utils.algorithm_globals.random_seed = seed
...
def get_random_target_circ(n, depth = 5, max_operands = 2, seed = circuit_seed):
...
# %%
target_circ = get_random_target_circ(n_qubits, seed = circuit_seed)
